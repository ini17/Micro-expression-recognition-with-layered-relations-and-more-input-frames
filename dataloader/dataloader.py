# from dataloader.Mydataset import MEDataset
# from dataloader.dataset import MEDataset
from dataloader.Mydataset2 import MEDataset
import numpy as np
import pandas as pd
...
def get_loader(csv_file, label_mapping, batch_size,
               catego, parallel=None, mat_dir=None,
